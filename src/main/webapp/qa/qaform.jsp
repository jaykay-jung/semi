...
<style type="text/css">
	...
	textarea {width: 100%;}
	#qaform-container {margin-bottom: 100px;}
	#h3-box {margin-bottom: 20px;}
	#qa-h3 {line-height: 40px; border-bottom: 1px solid #eee;}
...
<jsp:include page="../common/nav.jsp">
	<jsp:param name="menu" value="qaform"/>
</jsp:include>

<!-- content -->
<div class="container" id="qaform-container">
	<div class="row">
	...
	<div>
		<form method="post" action="qa.jsp">
			...
			<div class="row">
				<div class="col-6">
					<a href="qalist.jsp" class="btn btn-outline-primary">목록</a>
				</div>
				<div class="col-6 text-end">
					<button type="submit" class="btn btn-primary">등록</button>
					<a href="qalist.jsp" class="btn btn-outline-secondary">취소</a>
				</div>
			</div>
...
<jsp:include page="../common/footer.jsp">
	<jsp:param name="footer" value="qaform"/>
</jsp:include>
